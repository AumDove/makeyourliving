...
function mminfo_setup() {
	...
	register_nav_menus ( array (
		'primary-menu' => __( 'Primary Menu', 'mminfo' ),
		'secondary' => __( 'Secondary Menu', 'mminfo' ),  
	) );
}

add_action( 'after_setup_theme', 'mminfo_setup' );


// Register widget area 
function mminfo_widgets_init() {
	register_sidebar( array(
		'name'          => __( 'Sidebar 1', 'mminfo' ),
		'id'            => 'sidebar-1',
		'description'   => __( 'Add widgets here to appear in your sidebar.', 'mminfo' ),
...
add_action( 'widgets_init', 'mminfo_widgets_init' );

// defines custom markup for post comments
function mminfo_comments($comment, $args, $depth) {
