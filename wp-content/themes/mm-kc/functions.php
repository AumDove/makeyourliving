...
function mmkc_setup() {
	...
	register_nav_menus ( array (
		'primary-menu' => __( 'Primary Menu', 'mmkc' ),
		'secondary' => __( 'Secondary Menu', 'mmkc' ),  
	) );
}

add_action( 'after_setup_theme', 'mmkc_setup' );


// Register widget area 
function mmkc_widgets_init() {
	register_sidebar( array(
		'name'          => __( 'Sidebar 1', 'mmkc' ),
		'id'            => 'sidebar-1',
		'description'   => __( 'Add widgets here to appear in your sidebar.', 'mmkc' ),
...
add_action( 'widgets_init', 'mmkc_widgets_init' );

// defines custom markup for post comments
function mmkc_comments($comment, $args, $depth) {
